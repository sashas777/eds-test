...
## Environments
- Preview: https://main--eds_test--sashas777.aem.page/
- Live: https://main--eds_test--sashas777.aem.live/
...
1. Open the `eds_test` directory in your favourite IDE and start coding :)
